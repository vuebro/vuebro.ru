            ...
            <div class="container px-6 mx-auto">
                <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-6">
                    <div class="col-span-4 md:col-span-8 lg:col-span-4 mb-3">
                        ...
                        <div class="text-center mt-8"><a aria-label="Chat on WhatsApp" target="_blank"
                                rel="noopener noreferrer" href="https://wa.me/+79260429028"><img class="inline"
                                    alt="Chat on WhatsApp" src="images/WhatsAppButtonGreenSmall.svg" /></a></div>
                    </div>
